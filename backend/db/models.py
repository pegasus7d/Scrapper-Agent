...
class Company(Base):
    ...
    # PHASE9.md step 9): "yc" | "largest_us_companies" | "a16z" |
    # "sequoia" | "foundersfund" | "bvp" | "russell1000". Defaults to "yc"
    # — every company discovered before this column existed came from
    # that source.
