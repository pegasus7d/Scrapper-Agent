...
- What the app can actually do today: [[FEATURES.md]]
...
> **Status:** phases 1–8 complete (see [[docs/WORKFLOW.md]] and
> [[docs/phases/PHASE8.md]]). See [[FEATURES.md]] for the current feature
> list — kept there, not duplicated here, so it doesn't drift out of sync.
